...
export const selectPlannedMissions = createSelector(
    selectAllMissions,
...
export const selectMissionsCount = createSelector(
    selectAllMissions,
    (missions) => missions.length
)

export const selectMissionById = (id: number) => createSelector(
    selectAllMissions,
    (missions) => missions.find(m => m.id === id)
)