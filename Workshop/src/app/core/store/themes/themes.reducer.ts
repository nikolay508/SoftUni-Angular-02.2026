...
import { ThemesState } from "../../../shared/interfaces/themes-interfaces/themes-state";
...
export const themesReducer = createReducer(
    ...
    on(loadThemesSuccess, (state, { themes }): ThemesState => ({
        ...state,
        themes,
        isLoading: false,
    })),

    on(loadThemesFailure, (state, { error }): ThemesState => ({
        ...state,
        isLoading: false,
        error
    })),
